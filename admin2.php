...
if(isset($_POST['update'])){
    ...
    if(empty($name) || empty($artist) || empty($pic) || empty($genre) || empty($size)){
        ...
        $update = "UPDATE arts SET pic='$pic', aname='$name',artist='$artist',genre='$genre',asize='$size' WHERE aname='".$name."'";
...
<h1>UPDATE</h1><br>
NAME:  &nbsp&nbsp&nbsp &nbsp&nbsp<input type = "text" value="<?php echo $row['aname'];?>" name="name" class="box"><br><br>
ARTIST: &nbsp&nbsp&nbsp&nbsp  <input type = "text" value="<?php echo $row['artist'];?>" name="artist" class="box"><br><br>
GENRE:  &nbsp&nbsp&nbsp&nbsp <input type = "text" value="<?php echo $row['genre'];?>" name="genre" class="box"><br><br>
SIZE: &nbsp&nbsp &nbsp&nbsp&nbsp&nbsp <input type = "text" value="<?php echo $row['asize'];?>" name="size" class="box"><br><br>
IMAGE: &nbsp&nbsp<input type = "file" accept="image/png, image/jpeg, image/jpg" name="pic" class="box"><br><br><br>
<button type = "submit" name="update" value="update product">UPDATE ART</button><br><br><br>
</center>
</form>
<?php } ?>
<?php
