...
/* Set a black background and white text for the footer */
footer {
    background-color: black;
    color: white;
    text-align: center;
...
<div class="mossgalimg">
  ...
  <div class="admin" style="font-family: Garamond, serif;">
  <a href="adlog.php">ADMIN</a></div>
	<h1 style="font-family: 'Snell Roundhand', cursive; color: white; font-size: 100px; font-style: italic;">
		&nbsp;MOSS<br><br>&nbsp;Galleries</h1>
</div></div><br><br>
...
<div class="col-lg-6">
<h4>Quick links</h4>
<a href="trialhome1.php">Home</a><br>
